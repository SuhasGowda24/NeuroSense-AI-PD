        ...
        <div className="h-48 mb-4">
          ...
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={chartData}>
              ...
              />
              <Line type="monotone" dataKey="mood" stroke="#8b5cf6" strokeWidth={2} name="Mood" dot={{ fill: '#8b5cf6', r: 4 , strokeWidth: 2, stroke: '#fff' }} activeDot={{ r: 7, strokeWidth: 2, stroke: '#8b5cf6' }}
